    ...
    >
      ...
      >
        <header
          ...
          className={`flex items-start gap-3 border-b border-stone-200 px-4 py-3 select-none dark:border-white/[0.16] ${
