  ...
  return (
    <div className={`relative flex w-full justify-center ${className}`}>
      ...
      <button
        ...
        className={`group relative inline-flex h-8 items-center justify-center rounded-[9px] px-3 text-[12.5px] font-medium transition-[background-color,box-shadow,transform] duration-150 outline-none select-none focus-visible:bg-[#4568FF]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#4568FF] dark:focus-visible:bg-[#93B0FF]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#93B0FF] ${
          inert
            ? "cursor-default"
