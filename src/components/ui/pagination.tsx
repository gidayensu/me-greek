              ...
              return (
                <li key={`slot-${item}`} style={{ width: slot }}>
                  <button
                    ...
                    className={`flex h-8 w-full items-center justify-center rounded-[9px] text-[12.5px] tabular-nums transition-colors duration-150 outline-none focus-visible:bg-[#4568FF]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#4568FF] dark:focus-visible:bg-[#93B0FF]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#93B0FF] ${
                      selected
