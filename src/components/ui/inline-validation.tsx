    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="relative mt-1.5">
        <input
          ...
          {...fieldProps}
          className={`h-10 w-full rounded-[10px] border-2 pr-9 pl-3 text-[13px] text-stone-700 transition-[background-color,border-color,box-shadow] duration-150 outline-none placeholder:text-stone-400 focus-visible:outline-none disabled:opacity-50 dark:text-stone-200 dark:placeholder:text-stone-500 ${
            invalid
