  ...
  return (
    <span className={`inline-flex items-center ${className}`}>
      <button
        ...
        className="inline-flex h-9 items-center gap-2 rounded-[9px] border border-stone-200 bg-white px-3 text-[13px] font-medium text-stone-700 outline-none select-none focus-visible:ring-2 focus-visible:ring-stone-400 disabled:opacity-50 dark:border-white/[0.16] dark:bg-[#1D1D1A] dark:text-stone-200 dark:focus-visible:ring-stone-500"
      >
        ...
        <span
          aria-hidden
          className="grid overflow-hidden text-[12px] text-stone-500 tabular-nums dark:text-stone-400"
        >
