...
export function IconMorph({
  ...
  return (
    <motion.button
      ...
      className={`inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-[9px] border border-stone-200 bg-white text-[13px] font-medium text-stone-700 outline-none select-none focus-visible:ring-2 focus-visible:ring-stone-400 disabled:opacity-50 dark:border-white/[0.16] dark:bg-[#1D1D1A] dark:text-stone-200 dark:focus-visible:ring-white/30 ${
        showLabel ? "px-3" : "w-9"
      } ${className}`}
