  ...
  return (
    ...
    >
      <div
        ...
        className="[scrollbar-gutter:stable] overflow-y-auto overscroll-y-contain outline-none focus-visible:bg-[#4568FF]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#4568FF] dark:focus-visible:bg-[#93B0FF]/[0.06] dark:focus-visible:shadow-[inset_0_0_0_1px_#93B0FF]"
      >
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 flex items-start gap-2.5 px-4 pt-3">
          ...
          <div className="relative min-w-0 flex-1">
            ...
            >
              <h2 className="truncate text-[20px] leading-[1.2] font-medium tracking-[-0.03em] text-stone-800 dark:text-stone-100">
                {title}
              </h2>
              {subtitle ? (
            ...
            <motion.span
              ...
              className="absolute inset-x-0 top-[3px] truncate text-[13px] leading-[1.4] font-medium text-stone-700 dark:text-stone-200"
            >
              {title}
            </motion.span>
          </div>
