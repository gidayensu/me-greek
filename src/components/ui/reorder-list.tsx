        ...
        {items.map((item) => {
          ...
          return (
            <Reorder.Item
              ...
              className={`relative flex items-center gap-2.5 rounded-[9px] border bg-white px-3 py-2.5 transition-[border-color,box-shadow,background-color] duration-150 outline-none focus-visible:outline-none dark:bg-[#1D1D1A] ${
                lifted
