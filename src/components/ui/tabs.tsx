    ...
    >
      ...
      >
        <motion.span
          ...
          className="absolute top-1 bottom-[-1px] bg-white dark:bg-[#1D1D1A]"
        ...
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`relative flex h-8 shrink-0 items-center justify-center rounded-t-[8px] px-3.5 text-[12.5px] transition-colors duration-150 outline-none after:pointer-events-none after:absolute after:inset-0 after:rounded-t-[8px] after:content-[''] focus-visible:after:shadow-[inset_0_0_0_1px_#4568FF] dark:focus-visible:after:shadow-[inset_0_0_0_1px_#93B0FF] ${
                item.disabled
