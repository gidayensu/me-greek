...
function Row({
  ...
  return (
    ...
    <button
      ...
      className={`group relative h-9 w-full overflow-hidden rounded-[8px] border text-left transition-[border-color,background-color,box-shadow,transform] duration-200 outline-none focus-visible:after:pointer-events-none focus-visible:after:absolute focus-visible:after:inset-0 focus-visible:after:rounded-[7px] focus-visible:after:bg-[#4568FF]/[0.06] focus-visible:after:shadow-[inset_0_0_0_1px_#4568FF] dark:focus-visible:after:bg-[#93B0FF]/[0.1] dark:focus-visible:after:shadow-[inset_0_0_0_1px_#93B0FF] ${
        revealed
      ...
      <span className="relative flex h-full items-center gap-2 px-3">
        ...
        <span className="relative grid shrink-0 text-right">
          ...
          <motion.span
            ...
            className="col-start-1 row-start-1 font-mono text-[11px] text-stone-500 tabular-nums dark:text-stone-400"
          >
            0%
          </motion.span>
        </span>
...
export function PollResults({
  ...
  return (
    <div role="group" aria-label={label} className={`w-full ${className}`}>
      ...
      <p className="mt-2 h-4 font-mono text-[10.5px] text-stone-400 tabular-nums dark:text-stone-500">
        <motion.span
          initial={false}
