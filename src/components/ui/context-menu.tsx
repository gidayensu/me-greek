              ...
              {items.map((item, index) =>
                item.type === "separator" ? (
                  ...
                  <button
                    ...
                    {...getItemProps(index)}
                    className={`flex h-[32px] w-full cursor-default items-center gap-2 rounded-[7px] px-2.5 text-left text-[13px] outline-none select-none ${
                      item.disabled
                  ...
                  >
                    ...
                    {item.shortcut ? (
                      <span
                        aria-hidden
                        className="shrink-0 font-mono text-[10.5px] text-stone-500 tabular-nums dark:text-stone-400"
                      >
                        {item.shortcut}
                      </span>
                    ) : null}
