          ...
          >
            ...
            >
              ...
              {percent !== null && phase === "running" ? (
                <span className="font-mono text-[10.5px] text-stone-500 tabular-nums dark:text-stone-400">
                  {percent}%
                </span>
              ) : (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {activity.action ? (
                  <button
                    ...
                    className="inline-flex h-[24px] shrink-0 items-center rounded-[6px] border border-stone-200 bg-white px-2 text-[11px] font-medium whitespace-nowrap text-stone-700 shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(28,25,23,0.06),0_1px_2px_rgba(28,25,23,0.08)] transition-[background-color,border-color,box-shadow] duration-150 outline-none select-none hover:bg-stone-50 focus-visible:border-[#4568FF] active:translate-y-px dark:border-white/[0.16] dark:bg-[#2A2A27] dark:text-stone-100 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_1px_2px_rgba(0,0,0,0.4)] dark:hover:bg-[#32322E] dark:focus-visible:border-[#93B0FF]"
                  >
              ...
              {percent !== null && phase !== "error" ? (
                <div className="mt-2.5 flex items-center gap-2 pl-[26px]">
                  ...
                  <span className="shrink-0 font-mono text-[10.5px] text-stone-500 tabular-nums dark:text-stone-400">
                    {percent}%
                  </span>
                </div>
              ) : null}
