        ...
        {filters.map((filter, i) => {
          ...
          return (
            <button
              ...
              className="group relative inline-grid h-8 place-items-center rounded-[6px] px-3 outline-none select-none focus-visible:shadow-[0_1px_3px_rgba(28,25,23,0.18)] dark:focus-visible:shadow-[0_1px_3px_rgba(0,0,0,0.5)]"
            ...
            >
              ...
              <span className="relative col-start-1 row-start-1 inline-grid">
                <motion.span
                  ...
                  transition={swap}
                  className="col-start-1 row-start-1 inline-flex items-center gap-1.5 text-[12.5px] font-medium whitespace-nowrap text-stone-700 dark:text-stone-200"
                >
                  {filter.label}
                  <span className="text-[10.5px] text-stone-500 tabular-nums dark:text-stone-400">
                    {counts[filter.id]}
                  </span>
                </motion.span>
                <motion.span
                  ...
                  transition={swap}
                  className="col-start-1 row-start-1 inline-flex items-center gap-1.5 text-[12.5px] font-medium whitespace-nowrap text-stone-50 dark:text-stone-900"
                >
                  {filter.label}
