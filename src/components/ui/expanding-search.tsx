    ...
    >
      ...
      >
        <motion.input
          ...
          className="absolute inset-y-0 bg-transparent text-[13px] leading-9 text-stone-700 outline-none placeholder:text-stone-400 focus-visible:outline-none dark:text-stone-200 dark:placeholder:text-stone-500 [&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:appearance-none"
        />
        ...
        >
          {resultCount === undefined ? null : (
            <span
              aria-hidden
              className="w-8 truncate text-right font-mono text-[9.5px] text-stone-500 tabular-nums dark:text-stone-400"
            >
              {filled ? resultCount : ""}
            </span>
          )}
