  ...
  return (
    <div>
      <div role="heading" aria-level={headingLevel}>
        <button
          {...header}
          className="flex w-full items-center gap-3 px-3.5 py-3 text-left transition-colors duration-150 outline-none hover:bg-stone-100 focus-visible:bg-[#4568FF]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#4568FF] dark:hover:bg-white/10 dark:focus-visible:bg-[#93B0FF]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#93B0FF]"
        >
          <span
          ...
          {item.meta ? (
            <span className="shrink-0 text-[11.5px] text-stone-400 tabular-nums dark:text-stone-500">
              {item.meta}
            </span>
          ) : null}
      ...
      >
        ...
        >
          <motion.div
            ...
            className="px-3.5 pt-3 pb-3.5 text-[12.5px] leading-relaxed text-stone-500 dark:text-stone-400"
          >
            {item.content}
          </motion.div>
        </div>
