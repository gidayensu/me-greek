      ...
      return (
        <li key={node.id} role="none">
          <div
            ...
            className={`flex h-7 cursor-default items-center gap-1 rounded-[8px] px-1.5 transition-colors duration-150 outline-none select-none focus-visible:bg-[#4568FF]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#4568FF] dark:focus-visible:bg-[#93B0FF]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#93B0FF] ${
              isSelected
          ...
          >
            ...
            {node.meta ? (
              <span className="shrink-0 font-mono text-[10.5px] text-stone-400 tabular-nums dark:text-stone-500">
                {node.meta}
              </span>
            ) : null}
          </div>
