  ...
  const surface = (
    ...
    >
      <div className="flex h-11 items-center gap-2.5 border-b border-stone-200 px-3 dark:border-white/[0.16]">
        ...
        />
        <span className="min-w-[3ch] shrink-0 text-right font-mono text-[9.5px] text-stone-500 tabular-nums dark:text-stone-400">
          {count}
        </span>
      </div>
                  ...
                  {item.shortcut ? (
                    <span className="ml-auto flex shrink-0 items-center gap-1">
                      {item.shortcut.map((key) => (
                        <span
                          key={key}
                          className="flex h-[18px] min-w-[18px] items-center justify-center rounded-[5px] border border-stone-200 px-1 font-mono text-[9.5px] text-stone-500 tabular-nums dark:border-white/[0.16] dark:text-stone-400"
                        >
                          {key}
                        </span>
                      ))}
